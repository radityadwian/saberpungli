...
<div class="card">
  ...
  <p><a class="button" style="background-color: blue;" href="save_pungli.php?id='.$row['id'].'" target="_blank">Simpan Tiket</a><a class="button" style="background-color: grey;" href="pungli.php">Kembali</a></p>';
  }
  ?>
</div>
